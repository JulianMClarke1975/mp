...
<main id="site-content" role="main" <?php body_class(); ?>>
	...
	if( get_sub_field('page_section_type') == 'gallery' ) {
		get_template_part( 'template-parts/content-gallery' );
	}
	if( get_sub_field('page_section_type') == 'casestudytestserv' ) {
		get_template_part( 'template-parts/content-casestudytestserv' );
	}
